function DefaultScreen(props) {
  ...
  return (
    <div>
      ...
      <input ref={input => {input && props.focus === 'range'? input.focus() : ''}} id="range" value={props.range} type="text" size="5" autoComplete="off" onFocus={() => {props.focus != 'range'? props.toggleFocus() : ''}} onChange={e => props.updateInput(e)} onKeyUp={e => {e.keyCode == 13? props.initialize() : e.keyCode == 40 || e.keyCode == 9? props.toggleFocus() : e.keyCode == 39? props.toggleMathType(true) : e.keyCode == 37? props.toggleMathType(false) : ''}} />
      How many questions?
